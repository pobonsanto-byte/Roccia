...
def level_roles():
    ...
    return render_template('level_roles.html', level_roles=dict(sorted_roles))
...
def view_warns():
    ...
    # Ordena pelo número de advertências
    user_warns.sort(key=lambda x: x['count'], reverse=True)
